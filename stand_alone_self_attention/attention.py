...
class AttentionConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, groups=1, bias=False):
        ...
        assert self.out_channels % self.groups == 0, "out_channels should be divided by groups. (example: " \
                                                     "out_channels: 40, groups: 4) "
...
if __name__ == '__main__':
    ...
    conv = AttentionConv2d(3, 16, kernel_size=3, padding=1)
